// 第一步 提供 window.external.upload 函数，在页面中模拟创建上传插件
...
// 第三步 往页面中创建跟上传流程有关的DOM 节点，并开始绑定按钮的事件
...
// 第四步，负责具体的按钮事件实现，在点击了按钮之后， Context 并不做任何具体的操作，
// 而是把请求委托给当前的状态类来执行
...
// 第五步 编写各个状态类的实现 模拟抽象类 StateFactory
